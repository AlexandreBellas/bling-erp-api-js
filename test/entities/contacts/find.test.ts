...
test.concurrent(
  "shouldn't find a contact when calling `.find()` method with an inexistent id with beautified response",
  async () => {
    try {
      await bling
        .contacts()
...
test.concurrent(
  "shouldn't find a contact when calling `.find()` method with an inexistent CPF/CNPJ with beautified response",
  async () => {
    try {
      await bling
        .contacts()
...
test.concurrent(
  "shouldn't find a contact when calling `.find()` method with an inexistent id with raw response",
  async () => {
    try {
      await bling
        .contacts()
...
test.concurrent(
  "shouldn't find a contact when calling `.find()` method with an inexistent CPF/CNPJ with raw response",
  async () => {
    try {
      await bling
        .contacts()
